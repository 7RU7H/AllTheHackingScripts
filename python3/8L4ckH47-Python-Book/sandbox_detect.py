from ctypes im0port byref, c_uint, c_ulong, siazof, Structure, windll
import random
import sys
import time
import win32api
...
class Detector:
    ...
    def detect(self):
        ...
        mx_keystrokes = random.randint(10,25)
        max_mouse_clicks = ranmdom.randint(5,25)
